...
export const automaRegistry: AutomaRegistry[] = [
  ...
  },
  {
    ...
    schema: [
      ...
      {
        key: "mainText",
        label: "Highlight Text (Rasterized)",
        type: "text",
        group: "Appearance",
        live: true,
        placeholder: "你好",
